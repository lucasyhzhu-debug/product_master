...
export const PLATFORMS: Record<PlatformId, PlatformMeta> = {
  k3mart: {
    ...
    reconnectSteps: [
      "Click 'Configure' below and enter your K3 Mart email and password",
      "Click 'Save & Refresh' — token auto-refreshes every 12 hours",
      "If auto-refresh fails, manually update: open https://umkm.k3mart.id and log in",
      "Open browser DevTools (F12) → Network tab",
      "Look for any API request to consapi.k3mart.id",
      "Copy the Authorization header value (after 'JWT ')",
      "Go to Convex Dashboard → Settings → Environment Variables → update K3MART_API_TOKEN",
    ],
  },
  gobiz: {
    id: "gobiz",
