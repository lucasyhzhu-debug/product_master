...
vi.mock('../../../convex/_generated/api', () => ({
  api: {
    ...
    orders: {
      ...
      mutations: {
        create: 'orders.mutations.create',
        updateStatus: 'orders.mutations.updateStatus',
        updatePayment: 'orders.mutations.updatePayment',
        updateShipping: 'orders.mutations.updateShipping',
        updateDetails: 'orders.mutations.updateDetails',
        cancel: 'orders.mutations.cancel',
        remove: 'orders.mutations.remove',
        addItem: 'orders.mutations.addItem',
        removeItem: 'orders.mutations.removeItem',
        updateItemQuantity: 'orders.mutations.updateItemQuantity',
      },
      whatsapp: {
