...
Last activity: 2026-02-25 - Completed quick task 28: harden sync-prod-to-dev.sh with auth pre-flight, --no-confirm flag, Windows path guard, post-import spot-check
...
| 28 | Harden sync-prod-to-dev.sh: auth pre-flight (npx convex whoami), --no-confirm CI flag, Windows path guard (cygpath fallback), post-import spot-check (ingredients:list count) | 2026-02-25 | 3b3af6f | Verified | [28-build-a-reliable-process-to-run-the-sync](./quick/28-build-a-reliable-process-to-run-the-sync/) |
