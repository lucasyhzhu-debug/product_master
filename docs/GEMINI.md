...
**Frollie Pro** — A local-first recipe, product concept, and order management system for an Indonesian FMCG snack company. Tracks food recipes, packaging recipes, product concepts with full versioning, and manages customer orders with COGS/Margin analysis.
