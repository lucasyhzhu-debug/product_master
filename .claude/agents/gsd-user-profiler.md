...
<reference>
@D:/Claude/Product Manager/product_master/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Claude/Product Manager/product_master/.claude/get-shit-done/references/user-profiling.md` to load:
