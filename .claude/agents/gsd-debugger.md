...
<required_reading>
@D:/Claude/Product Manager/product_master/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Claude/Product Manager/product_master/.claude
                  → checks D:/Claude/Product Manager/product_master/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Claude/Product Manager/product_master/.claude/get-shit-done
                  → writes to D:/Claude/Product Manager/product_master/.claude/get-shit-done/hooks/
...
@D:/Claude/Product Manager/product_master/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Claude/Product Manager/product_master/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
node "D:/Claude/Product Manager/product_master/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/Claude/Product Manager/product_master/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
