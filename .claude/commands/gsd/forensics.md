...
<execution_context>
@D:/Claude/Product Manager/product_master/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @D:/Claude/Product Manager/product_master/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
