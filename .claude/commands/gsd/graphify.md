...
```
PREFLIGHT=$(node "D:/Claude/Product Manager/product_master/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: D:/Claude/Product Manager/product_master/.claude/get-shit-done/bin/gsd-tools.cjs
