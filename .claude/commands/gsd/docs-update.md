...
<execution_context>
@D:/Claude/Product Manager/product_master/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @D:/Claude/Product Manager/product_master/.claude/get-shit-done/workflows/docs-update.md end-to-end.
