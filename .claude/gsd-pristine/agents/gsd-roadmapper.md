...
Reference full template: `D:/Claude/Product Manager/product_master/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Claude/Product Manager/product_master/.claude/get-shit-done/templates/state.md`.
