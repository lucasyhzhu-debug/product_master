...
- Usage: Reference from command with `@D:/Claude/Product Manager/product_master/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Claude/Product Manager/product_master/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Claude/Product Manager/product_master/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
