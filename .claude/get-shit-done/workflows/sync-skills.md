...
INSTALL_JS_GLOBAL="D:/Claude/Product Manager/product_master/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Claude/Product Manager/product_master/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
