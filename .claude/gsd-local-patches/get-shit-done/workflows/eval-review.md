...
```bash
AUDITOR_MODEL=$(node "D:/Claude/Product Manager/product_master/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read D:/Claude/Product Manager/product_master/.claude/agents/gsd-eval-auditor.md for instructions.
